...
+
스토리지 플러그인의 경우 _C:\ProgramData\NetApp\SnapCenter\Package Repository_로 이동하여 을 선택합니다 `Storage.zip` 폴더.
...
+
MySQL 또는 DB2 애플리케이션을 관리하려는 경우 NetApp에서 제공하는 MySQL 및 DB2 사용자 지정 플러그인을 사용할 수 있습니다.
