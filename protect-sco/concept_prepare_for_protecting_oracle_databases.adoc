...
* SAN 환경에 Oracle 데이터베이스가 있는 경우 가이드에 언급된 권장 사항에 따라 SAN 환경을 https://library.netapp.com/ecm/ecm_download_file/ECMP1119218["AIX 호스트 유틸리티의 영향을 받는 호스트 설정"^] 구성해야 합니다.
